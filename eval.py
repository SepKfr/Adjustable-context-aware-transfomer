...
def evaluate(site, seq_ln):
    ...
    plt.plot(np.arange(143, 216), preds_attn_con[best_ind, :].detach().numpy(), color='deepskyblue')
    plt.plot(np.arange(143, 216), preds_attn[best_ind, :].detach().numpy(), color='seagreen')
    plt.plot(np.arange(143, 216), preds_attn_conv[best_ind, :].detach().numpy(), color='orange')
    plt.plot(np.arange(143, 216), preds_lstm[best_ind, :].detach().numpy(), color='salmon')
