...
def perform_evaluation(args, device, params, test, valid_max, formatter):
    ...
    def create_rmse_plot():
        ...
        plt.plot(x_1, np.append(attn_temp_cutoff_24[0::8], attn_temp_cutoff_24[-1]), marker="o", linestyle="-", color='orange')
        plt.plot(x_1, np.append(attn_conv_24[0::8], attn_conv_24[-1]), marker="o", linestyle="-", color='seagreen')
        plt.plot(x_1, np.append(attn_24[0::8], attn_24[-1]), marker="o", linestyle="-", color='red')
        plt.plot(x_1, np.append(attn_multi_24[0::8], attn_multi_24[-1]), marker="o", linestyle="-", color='violet')
        plt.plot(x_1, np.append(lstm_24[0::8], lstm_24[-1]), marker="o", linestyle="-", color='salmon')
        plt.plot(x_2, np.append(attn_temp_cutoff_48[0::8], attn_temp_cutoff_48[-1]), marker="d", linestyle="-", color='orange')
        plt.plot(x_2, np.append(attn_conv_48[0::8], attn_conv_48[-1]), marker="d", linestyle="-", color='seagreen')
        plt.plot(x_2, np.append(attn_48[0::8], attn_48[-1]), marker="d", linestyle="-", color='red')
        plt.plot(x_2, np.append(attn_multi_48[0::8], attn_multi_48[-1]), marker="d", linestyle="-", color='violet')
        plt.plot(x_2, np.append(lstm_48[0::8], lstm_48[-1]), marker="d", linestyle="-", color='salmon')
