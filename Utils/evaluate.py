...
def perform_evaluation(args, device, params, test, valid_max, formatter):
    ...
    def create_rmse_plot():
        ...
        plt.plot(x_1, attn_temp_cutoff_24, marker='o-', color='orange')
        plt.plot(x_1, attn_conv_24, marker='o-', color='seagreen')
        plt.plot(x_1, attn_24, marker='o-', color='red')
        plt.plot(x_1, attn_multi_24, marker='o-', color='violet')
        plt.plot(x_1, lstm_24, marker='o-', color='salmon')
        plt.plot(x_2, attn_temp_cutoff_48, marker='d-', color='orange')
        plt.plot(x_2, attn_conv_48, marker='d-', color='seagreen')
        plt.plot(x_2, attn_48, marker='d-', color='red')
        plt.plot(x_2, attn_multi_48, marker='d-', color='violet')
        plt.plot(x_2, lstm_48, marker='d-', color='salmon')
