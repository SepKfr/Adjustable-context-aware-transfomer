...
def perform_evaluation(args, device, params, test, valid_max, formatter):
    ...
    def create_rmse_plot():
        ...
        plt.plot(x_1, np.append(attn_24[0::8], attn_24[-1]), marker="^", linestyle="-", color='goldenrod')
        plt.plot(x_1, np.append(attn_multi_24[0::8], attn_multi_24[-1]), marker="^", linestyle="-", color='lightgreen')
        ...
        plt.plot(x_2, np.append(attn_48[0::8], attn_48[-1]), marker="o", linestyle="-", color='goldenrod')
        plt.plot(x_2, np.append(attn_multi_48[0::8], attn_multi_48[-1]), marker="o", linestyle="-", color='lightgreen')
    ...
    def plot_train_loss(len_pred):
        ...
        _, attn_multi_losses[0, :] = load_attn(seed, configs["attn_multi_test_{}".format(9)],
