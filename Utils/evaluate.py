...
def perform_evaluation(args, device, params, test, valid_max, formatter):
    ...
    def create_attn_score_plots():
        ...
        ax_1.plot(x[0::2], enc_attn_temp_cutoff_scores[ind, 0::2] /
                  2*np.sum(enc_attn_temp_cutoff_scores[ind, 0::2]), color='darkblue')
        ...
        ax_1.plot(x_1[0::2], self_attn_temp_cutoff_scores[ind, 0::2]/
                  2*np.sum(self_attn_temp_cutoff_scores[ind, 0::2]), color='darkblue')
        ...
        ax_2.plot(x[0::2], dec_enc_attn_temp_cutoff_scores[ind, 0::2] /
                  2*np.sum(dec_enc_attn_temp_cutoff_scores[ind, 0::2]), color='darkblue')
